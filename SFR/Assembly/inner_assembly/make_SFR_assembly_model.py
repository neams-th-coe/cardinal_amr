...
def main():
    ...
    materials = openmc.Materials(
        [inner_fuel_material, sodium, helium, cladding_material]
    )
    ...
    inner_u = openmc.Universe(cells=[inner_cell, gas_gap_cell, clad_cell, sodium_cell])
