...
from SFR import common_input as assembly_geometric_params
from SFR.Pincell.make_openmc_model import get_pincell_universe


def argument_parser():
    ap = ArgumentParser(description="SFR assembly Model Generator")
    ap.add_argument("-n", dest="n_axial", type=int, default=assembly_geometric_params.AXIAL_DIVISIONS, help="Number of cells in the Z direction")
    ap.add_argument("-p", dest="pincell_type", type=str, choices=["inner", "outer"], default="inner", help="Material composition of the assembly fuel material")
